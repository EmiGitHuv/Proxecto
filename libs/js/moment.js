; (function (global, factory) {
    ...
    hooks.defineLocale('es', {
        ...
        longDateFormat: {
            ...
            LLT: 'D [de] MMMM [de] YYYY H:mm',
            LLLT: 'dddd, D [de] MMMM [de] YYYY H:mm',
        },
        calendar: {
            sameDay: function () {
    ...
    hooks.defineLocale('gl', {
        ...
        weekdaysMin: 'do_lu_ma_me_xo_ve_sá'.split('_'),
        weekdaysParseExact: true,
        longDateFormat: {
            LT: 'H:mm',
            LTS: 'H:mm:ss',
        ...
        calendar: {
            sameDay: function () {
                return '[hoxe á' + (this.hours() !== 1 ? 's' : '') + '] LT';
            },
            nextDay: function () {
                return '[mañá á' + (this.hours() !== 1 ? 's' : '') + '] LT';
            },
            nextWeek: function () {
